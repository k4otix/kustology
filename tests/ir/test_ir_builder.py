...
def test_semantic_hash_carries_scheme_prefix(ir_builder):
    """The hash is prefixed with ``kustology-sem-v1:`` so the
    ...
    assert ir.semantic_hash.startswith("kustology-sem-v1:"), ir.semantic_hash
...
def test_compute_semantic_hash_accepts_subtree(ir_builder):
    ...
    assert h.startswith("kustology-sem-v1:")
